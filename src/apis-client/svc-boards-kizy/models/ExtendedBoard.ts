...
import {
    ...
    BatteryMeasurementUpdatedAtFromJSON,
    BatteryMeasurementUpdatedAtFromJSONTyped,
    BatteryMeasurementUpdatedAtToJSON,
    GpsMeasurementUpdatedAt,
    GpsMeasurementUpdatedAtFromJSON,
    GpsMeasurementUpdatedAtFromJSONTyped,
    GpsMeasurementUpdatedAtToJSON,
    SensorsMeasurementUpdatedAt,
    SensorsMeasurementUpdatedAtFromJSON,
    SensorsMeasurementUpdatedAtFromJSONTyped,
    SensorsMeasurementUpdatedAtToJSON,
} from './';
...
export interface ExtendedBoard {
    ...
    /**
     * 
     * @type {GpsMeasurementUpdatedAt}
     * @memberof ExtendedBoard
     */
    gps?: GpsMeasurementUpdatedAt;
    /**
     * 
     * @type {SensorsMeasurementUpdatedAt}
     * @memberof ExtendedBoard
     */
    sensors?: SensorsMeasurementUpdatedAt;
    /**
     * 
     * @type {BatteryMeasurementUpdatedAt}
     * @memberof ExtendedBoard
     */
    battery?: BatteryMeasurementUpdatedAt;
}
...
export function ExtendedBoardFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExtendedBoard {
    ...
    return {
        ...
        'gps': !exists(json, 'gps') ? undefined : GpsMeasurementUpdatedAtFromJSON(json['gps']),
        'sensors': !exists(json, 'sensors') ? undefined : SensorsMeasurementUpdatedAtFromJSON(json['sensors']),
        'battery': !exists(json, 'battery') ? undefined : BatteryMeasurementUpdatedAtFromJSON(json['battery']),
    };
}
...
export function ExtendedBoardToJSON(value?: ExtendedBoard | null): any {
    ...
    return {
        ...
        'gps': GpsMeasurementUpdatedAtToJSON(value.gps),
        'sensors': SensorsMeasurementUpdatedAtToJSON(value.sensors),
        'battery': BatteryMeasurementUpdatedAtToJSON(value.battery),
    };
}
