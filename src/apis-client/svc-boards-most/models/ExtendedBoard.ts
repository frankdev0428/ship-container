...
import {
    MostEventUpdatedAt,
    MostEventUpdatedAtFromJSON,
    MostEventUpdatedAtFromJSONTyped,
    MostEventUpdatedAtToJSON,
    MostLocationUpdatedAt,
    MostLocationUpdatedAtFromJSON,
    MostLocationUpdatedAtFromJSONTyped,
    MostLocationUpdatedAtToJSON,
    MostSensorsUpdatedAt,
    MostSensorsUpdatedAtFromJSON,
    MostSensorsUpdatedAtFromJSONTyped,
    MostSensorsUpdatedAtToJSON,
} from './';
...
export interface ExtendedBoard {
    ...
    /**
     * 
     * @type {MostEventUpdatedAt}
     * @memberof ExtendedBoard
     */
    event?: MostEventUpdatedAt;
    /**
     * 
     * @type {MostSensorsUpdatedAt}
     * @memberof ExtendedBoard
     */
    sensors?: MostSensorsUpdatedAt;
    /**
     * 
     * @type {MostLocationUpdatedAt}
     * @memberof ExtendedBoard
     */
    location?: MostLocationUpdatedAt;
}
...
export function ExtendedBoardFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExtendedBoard {
    ...
    return {
        ...
        'event': !exists(json, 'event') ? undefined : MostEventUpdatedAtFromJSON(json['event']),
        'sensors': !exists(json, 'sensors') ? undefined : MostSensorsUpdatedAtFromJSON(json['sensors']),
        'location': !exists(json, 'location') ? undefined : MostLocationUpdatedAtFromJSON(json['location']),
    };
}
...
export function ExtendedBoardToJSON(value?: ExtendedBoard | null): any {
    ...
    return {
        ...
        'event': MostEventUpdatedAtToJSON(value.event),
        'sensors': MostSensorsUpdatedAtToJSON(value.sensors),
        'location': MostLocationUpdatedAtToJSON(value.location),
    };
}
