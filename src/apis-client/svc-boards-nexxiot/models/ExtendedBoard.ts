...
import {
    ...
    NexxiotAlertMeasurementUpdatedAtFromJSON,
    NexxiotAlertMeasurementUpdatedAtFromJSONTyped,
    NexxiotAlertMeasurementUpdatedAtToJSON,
    NexxiotAssetMeasurementUpdatedAt,
    NexxiotAssetMeasurementUpdatedAtFromJSON,
    NexxiotAssetMeasurementUpdatedAtFromJSONTyped,
    NexxiotAssetMeasurementUpdatedAtToJSON,
    NexxiotDeviceMeasurementUpdatedAt,
    NexxiotDeviceMeasurementUpdatedAtFromJSON,
    NexxiotDeviceMeasurementUpdatedAtFromJSONTyped,
    NexxiotDeviceMeasurementUpdatedAtToJSON,
} from './';
...
export interface ExtendedBoard {
    ...
    /**
     * 
     * @type {NexxiotAssetMeasurementUpdatedAt}
     * @memberof ExtendedBoard
     */
    asset?: NexxiotAssetMeasurementUpdatedAt;
    /**
     * 
     * @type {NexxiotDeviceMeasurementUpdatedAt}
     * @memberof ExtendedBoard
     */
    device?: NexxiotDeviceMeasurementUpdatedAt;
    /**
     * 
     * @type {NexxiotAlertMeasurementUpdatedAt}
     * @memberof ExtendedBoard
     */
    alert?: NexxiotAlertMeasurementUpdatedAt;
}
...
export function ExtendedBoardFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExtendedBoard {
    ...
    return {
        ...
        'asset': !exists(json, 'asset') ? undefined : NexxiotAssetMeasurementUpdatedAtFromJSON(json['asset']),
        'device': !exists(json, 'device') ? undefined : NexxiotDeviceMeasurementUpdatedAtFromJSON(json['device']),
        'alert': !exists(json, 'alert') ? undefined : NexxiotAlertMeasurementUpdatedAtFromJSON(json['alert']),
    };
}
...
export function ExtendedBoardToJSON(value?: ExtendedBoard | null): any {
    ...
    return {
        ...
        'asset': NexxiotAssetMeasurementUpdatedAtToJSON(value.asset),
        'device': NexxiotDeviceMeasurementUpdatedAtToJSON(value.device),
        'alert': NexxiotAlertMeasurementUpdatedAtToJSON(value.alert),
    };
}
