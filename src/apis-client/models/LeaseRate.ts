...
export interface LeaseRate {
     ...
     * @memberof LeaseRate
     */
    currency: LeaseRateCurrencyEnum;
    /**
     * 
     * @type {Date}
     * @memberof LeaseRate
     ...
     * @memberof LeaseRate
     */
    lastOperation?: LeaseRateLastOperationEnum;
}
...
* @enum {string}
*/
export enum LeaseRateCurrencyEnum {
    Afn = 'AFN',
    All = 'ALL',
    Dzd = 'DZD',
    Adp = 'ADP',
...
* @enum {string}
*/
export enum LeaseRateLastOperationEnum {
    D = 'D',
    C = 'C',
    U = 'U'
}

export function LeaseRateFromJSON(json: any): LeaseRate {
    return LeaseRateFromJSONTyped(json, false);
}

export function LeaseRateFromJSONTyped(json: any, ignoreDiscriminator: boolean): LeaseRate {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'leaseRateId': json['leaseRateId'],
...
export function LeaseRateToJSON(value?: LeaseRate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
